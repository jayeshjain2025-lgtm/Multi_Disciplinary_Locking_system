  ...
  return (
    <div className="glass rounded-2xl p-6 h-1/2 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto space-y-3 pr-2 scrollbar-thin scrollbar-thumb-slate-800">
        ...
        {events.map((event) => (
          <div key={event.id} className="p-3 bg-white/5 border border-white/5 rounded-xl flex gap-3 animate-in slide-in-from-right duration-300">
            <div className="mt-1">
            ...
            <div className="flex-1 flex flex-col">
              ...
              <p className="text-sm text-slate-300 mt-1">{String(event.details)}</p>
            </div>
          </div>
        ))}
      </div>
